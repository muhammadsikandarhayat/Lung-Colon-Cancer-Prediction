...
def main():
    ...
    for cancer_type in cancer_types:
        print(f'\nTraining ResNet for {cancer_type} cancer classification')
        print('=' * 60)
        ...
        model_path = save_dir / f'{cancer_type}_resnet.pth'
        torch.save(best_model_state, model_path)
        print(f'\nBest model saved to {model_path}')
        metrics_path = save_dir / f'{cancer_type}_resnet_metrics.json'
        save_metrics(metrics_history, metrics_path)
        print(f'Metrics saved to {metrics_path}')
        plot_path = plots_dir / f'{cancer_type}_resnet_training_metrics.png'
